        ...
        <div id="scroll-bar">
            <nav className="header-nav">
                ...
                <div className={`links-container ${isMobileMenuOpen ? 'mobile-menu-open' : ''}`}>
                    <a href="#section1" onClick={closeMobileMenu}>Accueil</a>
                    <a href="#section2" onClick={closeMobileMenu}>À propos</a>
                    <a href="#section3" onClick={closeMobileMenu}>Portfolio</a>
                    <a href="#section4" onClick={closeMobileMenu}>Contact</a>
                </div>
